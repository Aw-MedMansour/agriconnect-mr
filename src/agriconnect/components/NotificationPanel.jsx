...
export default function NotificationPanel({ isOpen, notifications = [], onClose, onOpenNotification, onMarkAllRead, onDelete }) {
  ...
  return (
    <section aria-label={t('Notifications')} className="fixed end-3 top-[145px] z-50 flex max-h-[min(70vh,560px)] w-[calc(100vw-1.5rem)] max-w-[380px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl sm:end-5 sm:top-[160px]">
